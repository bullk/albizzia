...
all: splash-bullk my_pugl_cairo_test cairo_clip_test
...
cairo_clip_test: audioclip.o cairo_clip_test.o
	g++ -g -std=c++0x -Wall -O1 -D__LITTLE_ENDIAN__ -I. -I/usr/local/include/pugl-0 -I/usr/include/stk -o cairo_clip_test cairo_clip_test.o audioclip.o -lm -lpugl-0 -lGL -lcairo -lstk

splash-bullk: splash-bullk.cpp
	g++ -g -std=c++0x -Wall -O1 -D__LITTLE_ENDIAN__ -I. -I/usr/local/include/pugl-0 -o splash-bullk splash-bullk.cpp -lm -lpugl-0 -lGL -lcairo -lstk
